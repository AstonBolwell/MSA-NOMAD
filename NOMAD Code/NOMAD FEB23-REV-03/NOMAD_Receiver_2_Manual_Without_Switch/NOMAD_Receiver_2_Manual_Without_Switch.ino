...
void loop() {
  ...
  if (packetSize) // If data comes in, start a 5 second timer in which the loop exits after
  {
    ...
    while (1)
    {
      ...
      // Compare the current time to the previous time. If greater than 5, exit the loop
  ...
  {
    Serial.write("<NODATA,NODATA,NODATA>");
    Serial.write('\n');
  }
